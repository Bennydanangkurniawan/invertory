...
class Healty extends MY_Controller {
	...
	public function tambah()
	{
		...
		$data['barang'] = $this->M_distribusi->tampil_data('barang','nama_barang')->result();
	...
	public function cek_cost($id_barang)
	{

$cost = $this->M_distribusi->cek_cost($id_barang)->result();

$hasil = $cost[0]->jumlah_cost;
